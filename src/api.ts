...
const messages: Record<string, [string, string]> = {
  ...
  WECHAT_QR_INVALID: ['二维码无效或已过期，请刷新二维码后重新扫码。', 'This QR code is invalid or expired. Refresh it and scan again.'],
  WECHAT_QR_IMAGE_FAILED: ['二维码图片加载失败，请检查网络后点击“刷新二维码”重试。', 'The QR image could not be loaded. Check your connection and select “Refresh QR code” to try again.'],
  WECHAT_UNAVAILABLE: ['微信登录暂时不可用，请稍后重试或联系老师。', 'WeChat sign-in is temporarily unavailable. Try again later or contact the instructor.'],
  WECHAT_SESSION_CHANGED: ['扫码期间登录状态发生变化，请刷新页面确认当前账号后重新发起。', 'Your sign-in session changed while scanning. Refresh the page, check the current account, and start again.'],
  WECHAT_IDENTITY_CONFLICT: ['此微信已绑定其他账号。请使用原账号登录，或联系老师协助处理。', 'This WeChat identity is linked to another account. Sign in to that account or contact the instructor.'],
  WECHAT_ALREADY_LINKED: ['当前账号已绑定微信，请使用已绑定的微信登录；如需帮助，请联系老师。', 'This account already has a linked WeChat identity. Sign in with that identity or contact the instructor for help.'],
  ACCOUNT_ALREADY_SIGNED_IN: ['你已登录账号。如需关联微信，请使用账号区的“微信扫码绑定”。', 'You are already signed in. Use “Link with WeChat QR” in your account to connect WeChat.'],
